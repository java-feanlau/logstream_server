...
public class UpdateConfigResponseHandler extends SimpleChannelInboundHandler<HttpObject> {
...
//		}
		if (msg instanceof HttpContent) {
			...
			if (content instanceof LastHttpContent) {
				ManagerFactory.getClientManager().handleUpdateConfigResponse(contentBuffer.toString());
				ctx.close();
			}
