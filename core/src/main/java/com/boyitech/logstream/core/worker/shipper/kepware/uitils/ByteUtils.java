...
public abstract class ByteUtils {
	...
	public static short byte2ToChar(byte[] b, int offset) {
		short c = (short) (((b[offset] & 0xFF) << 8) | (b[offset + 1] & 0xFF));
		return c;
	}
	...
	/*
	 * @Author Eric Zheng
	 * @Description 大端小端的日结反转，af 00 e3 00 ->00 af 00 e3
	 *
	 * @Date 16:08 2019/1/14
	 * @Param [Byte]
	 * @return void
	 **/
	public static byte[] inversionBytes(byte[] a){
