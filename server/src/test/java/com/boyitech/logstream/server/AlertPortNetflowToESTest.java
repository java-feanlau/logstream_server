...
import com.boyitech.logstream.worker.indexer.VcenterNetflowV10V1Indexer;
 ...
 * @Description: 这是为了管理平台的告警写的，把数据发送到es的测试类。深信服的pvs、waf日志
 */
public class AlertPortNetflowToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-20191118-1";
    private String indexerName="vcenter-netflow-v10-v1";
    private String FILEPATH="/Users/juzheng/Desktop/netflow.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new VcenterNetflowV10V1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, VcenterNetflowV10V1Indexer.class);
