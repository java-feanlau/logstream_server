 ...
 */
public class AlertPortWindowsToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-20200107-windows";
    private String indexerName="microsoft_windows_all_v1";
    private String FILEPATH="/Users/juzheng/Desktop/windows.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new MicrosoftWindowsAllV1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, MicrosoftWindowsAllV1Indexer.class);
