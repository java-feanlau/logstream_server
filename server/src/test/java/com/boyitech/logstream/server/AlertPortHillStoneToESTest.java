...
import com.boyitech.logstream.worker.indexer.HillstoneFirewallAllV1Indexer;
 ...
 */
public class AlertPortHillStoneToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-hillstone-20191224";
    private String indexerName="hillstone_firewall_all_v1";
    private String FILEPATH="/Users/juzheng/Downloads/boyi/普通日志文件及相关/storeFire.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new HillstoneFirewallAllV1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
...
//                }
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, HillstoneFirewallAllV1Indexer.class);
