...
/**
 * @author juzheng
 * @Title: IndexerSjtuDrcomRadiusTxtTest
 * @date 2019/7/31 9:46 AM
 * @Description:   drcomradius日志格式化测试类
 */
public class IndexerSjtuDrcomRadiusTxtTest {
    ...
    public void Init(){
        ...
        Indexer=new DrcomRadiusAllV1Indexer(baseIndexerConfig);
        //2.此处修改日志样本的txt文件的路径：
        FILEPATH = "/Users/juzheng/Downloads/工作文件夹/sdju/sdju-drcom-radiu.txt";
        Indexer.register();
