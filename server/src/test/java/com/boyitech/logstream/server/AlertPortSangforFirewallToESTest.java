 ...
 */
public class AlertPortSangforFirewallToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-20191118-1";
    private String indexerName="sangfor-firewall-all-v1";
    private String FILEPATH="/Users/juzheng/Desktop/sangfor-firewall.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new SangforFirewallAllV1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, SangforFirewallAllV1Indexer.class);
