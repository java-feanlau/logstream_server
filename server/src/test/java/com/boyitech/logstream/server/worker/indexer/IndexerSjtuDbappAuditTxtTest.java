...
/**
 * @author juzheng
 * @Title: IndexerSjtuDbappAuditTxtTest
 * @date 2019/7/30 4:46 PM
 * @Description:
 */
public class IndexerSjtuDbappAuditTxtTest {
    ...
    public void Init(){
        ...
        Indexer=new DbappAuditAllV1Indexer(baseIndexerConfig);
        //2.此处修改日志样本的txt文件的路径：
        FILEPATH = "/Users/juzheng/Downloads/工作文件夹/sdju/sdju-audit.txt";
        Indexer.register();
