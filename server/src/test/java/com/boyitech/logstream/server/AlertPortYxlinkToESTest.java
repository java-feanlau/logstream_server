 ...
 */
public class AlertPortYxlinkToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-20191220-yxlink";
    private String indexerName="yxlink_waf_all_v1";
    private String FILEPATH="/Users/juzheng/Downloads/boyi/普通日志文件及相关/waf2.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new YxlinkWafAllV1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
...
//                }
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, YxlinkWafAllV1Indexer.class);
