 ...
 */
public class AlertPortDbappAptToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-20191118-1";
    private String indexerName="dbapp-apt-all-v1";
    private String FILEPATH="/Users/juzheng/Desktop/dbapp-apt.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new DbappAptAllV1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, DbappAptAllV1Indexer.class);
