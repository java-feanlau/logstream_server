...
import com.boyitech.logstream.worker.indexer.DrcomRadiusAllV1Indexer;
...
/**
 * @author juzheng
 * @Title: IndexerSjtuDbappAptTxtTest
 * @date 2019/7/31 10:02 AM
 * @Description:   安桓apt已经格式化，此测试类针对电机学院的apt日志样本作进一步测试以求完善
 */
public class IndexerSjtuDbappAptTxtTest {
    ...
    public void Init(){
        ...
        Indexer=new DbappAptAllV1Indexer(baseIndexerConfig);
        //2.此处修改日志样本的txt文件的路径：
        FILEPATH = "/Users/juzheng/Downloads/工作文件夹/sdju/sdju-apt.txt";
        Indexer.register();
