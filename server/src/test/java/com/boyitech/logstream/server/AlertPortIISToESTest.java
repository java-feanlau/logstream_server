...
import com.boyitech.logstream.worker.indexer.MicrosoftWebiisAllV1Indexer;
...
/**
 * @author juzheng
 * @Title: AlertPortIISToTest
 * @date 2019/10/31 5:58 PM
 * @Description: 这是为了管理平台的告警写的，把数据发送到es的测试类。
 */
public class AlertPortIISToESTest {
    private BaseCache LV2cache;
    private String comName="alert-test-20191101-3-iis";
    private String indexerName="microsoft_webiis_all_v1";
    private String FILEPATH="/Users/juzheng/Desktop/iis.txt";
    @Before
    public void buildEventTest() throws InterruptedException {
        ...
        BaseIndexer indexer = new MicrosoftWebiisAllV1Indexer(baseIndexerConfig);
        indexer.register();
        try
        {
    ...
    public void testESPorter() throws InterruptedException {
        ...
        BaseIndexerManager.putMapping(indexerName, MicrosoftWebiisAllV1Indexer.class);
