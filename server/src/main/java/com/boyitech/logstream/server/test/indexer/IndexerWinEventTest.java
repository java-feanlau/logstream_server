...
//import com.boyitech.logstream.worker.indexer.FortinetIndexer;
...
///**
// * @author juzheng
// * @Title: IndexerWinEventTest
// * @date 2019/4/23 1:56 PM
// * @Description:
// */
//public class IndexerWinEventTest {
//    private static final String FILEPATH = "/Users/juzheng/Downloads/IndexFile_Test_Out.txt";
//    //针对WinEvent的indexer的自动化的单元测试框架，只需改动elk解析后的日志路径Path即可
//
//    /**
//     * 流程：
//     * 连接redis，读原始日志数据-->>
...
//        long llen = jedis.llen("original:WinEvt");
//        list0 = jedis.lrange("original:WinEvt", 0, llen);
...
//        FortinetIndexer Indexer = new FortinetIndexer(baseIndexerConfig);
//        Indexer.register();
