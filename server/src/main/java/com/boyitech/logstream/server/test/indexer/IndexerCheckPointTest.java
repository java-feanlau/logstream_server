...
//        long llen = jedis.llen("checkpoint-firewall");
//        list0 = jedis.lrange("checkpoint-firewall", 0, llen);
...
//        CheckPointIndexer Indexer=new CheckPointIndexer(baseIndexerConfig);
//        Indexer.register();
