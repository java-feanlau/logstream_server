...
public class ServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public void initChannel(SocketChannel ch) {
        ...
        p.addLast(new HttpObjectAggregator(10*1024*1024));/*HTTP 消息的合并处理*/
        p.addLast(new DispatchActionHandler(SingleManagerFactory.getServerClientManager())); /*自己写的服务器逻辑处理*/
