...
///**
// * @author juzheng
// * @Title: IndexerFortinetTest
// * @date 2019/4/23 1:55 PM
// * @Description:
// */
//public class IndexerFortinetTest {
//    private static final String FILEPATH = "/Users/juzheng/Downloads/IndexFile_Test_Out.txt";
//    //针对FortinetPoint的indexer的自动化的单元测试框架，只需改动elk解析后的日志路径Path即可
//    /**
//     * 流程：
//     * 连接redis，读原始日志数据-->>
//     * 转义,取的message字段-->>
...
//        long llen=jedis.llen("fortinet-firewall");
//        list0=jedis.lrange("fortinet-firewall", 0, llen);
